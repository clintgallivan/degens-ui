...
import { Portfolio, SubstringSearchItem } from "../../PortfolioSection";
...
function EditableDistributionTable({
    ...
    weightValue: any;
    setWeightValue: Dispatch<any>;
    roundPortfolioTokens: () => any;
    addTokenRow: (item: SubstringSearchItem) => void;
    removeTokenRow: any;
}) {
    const lastUpdatedTokens = props.user.historical.portfolios[selectedPortfolio][0].tokens;
